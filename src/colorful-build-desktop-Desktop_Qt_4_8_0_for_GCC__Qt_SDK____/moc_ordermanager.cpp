...
#include "../colorful/ordermanager.h"
...
static const char qt_meta_stringdata_OrderManager[] = {
    "OrderManager\0\0orderNO\0pay(quint32)\0"
    "payOrder(quint32)\0"
};
...
void OrderManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->pay((*reinterpret_cast< quint32(*)>(_a[1]))); break;
        case 1: _t->payOrder((*reinterpret_cast< quint32(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void OrderManager::pay(quint32 _t1)
{
